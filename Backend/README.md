<img style="height: 200px; margin-top: 20px; margin-bottom: 40px;" alt="imagen del negocio" src="https://scontent-bog1-1.xx.fbcdn.net/v/t39.30808-6/277173439_139411891916162_4731320202830065103_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=8bfeb9&_nc_eui2=AeGV87crbQihvJNIVdf7m1Ms3SREh8dilrPdJESHx2KWsy5GOP7tC_EKx6b9NxmI-VzD3X5Db-iRuOC6Iiwfn15J&_nc_ohc=A_4jFKRRnS4AX8PYo6a&_nc_ht=scontent-bog1-1.xx&oh=00_AT9fEzptX77vWPXECCGzv3p3uWExrWBOy4CkZE5pdBW7-A&oe=62B92091">
...
|[Script para creación de BD](BD)| Contiene el script de la base de datos .|
|[Routes](/src/modulos/routes)| Contiene las rutas de todas las pestañas que permite su concexion y funcionamiento con express y node.je .|
|[Services](/src/modulos/services)| Contiene todos los archivos que realizan acciones a la base de datos, CRUD, conteos, etc. .|
|[Index.js](/src/index.js)| Configura el uso de express, sus modulos, routing y endpoints.|
|[Database](/src/modulos/database)| Contiene los datos de acceso a la base de datos .|
